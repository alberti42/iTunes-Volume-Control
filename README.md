...
* [1.6.3.2](http://quantum-technologies.iap.uni-bonn.de/alberti/iTunesVolumeControl/iTunesVolumeControl-v1.6.3.2.zip): Fixed crash on start due to failed permissions for AppleEvents.
